        ...
        <div className="max-w-3xl">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="h-[1.5px] w-8 bg-white/80" />
              <span className="text-white/85 text-[9px] md:text-[11px] font-bold tracking-[0.3em] uppercase heading-font">{label}</span>
            </div>
            ...
            <p className="text-white/80 text-sm md:text-xl max-w-xl leading-relaxed font-sans">{subtitle}</p>
            <div className="flex flex-wrap items-center gap-6 pt-4">
              <a
                ...
                className="group relative overflow-hidden bg-white text-black px-10 md:px-12 py-4 md:py-5 rounded-full font-bold text-[10px] md:text-xs uppercase tracking-[0.2em] transition-all duration-500 shadow-xl border border-black/20 active:scale-95 block w-fit"
              >
