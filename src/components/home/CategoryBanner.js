      ...
      <div className="mx-4 md:mx-8 bg-white border border-black/5 rounded-[40px] shadow-sm overflow-hidden py-16 md:py-24 px-6 md:px-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="space-y-3">
            ...
            <p className="text-lg sm:text-2xl md:text-4xl lg:text-5xl font-bold heading-font tracking-tighter text-black uppercase leading-none truncate">
                ...
                <div className={`absolute inset-0 p-8 md:p-12 flex flex-col justify-end ${isSmall ? 'items-center text-center' : 'items-start text-left'}`}>
                  <div className={`space-y-5 w-full flex flex-col ${isSmall ? 'items-center' : 'items-start'}`}>
                    <div className="space-y-2">
                      ...
                      <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white uppercase tracking-tighter leading-[0.9]">
                        {category.name}
                      </p>
                    </div>
