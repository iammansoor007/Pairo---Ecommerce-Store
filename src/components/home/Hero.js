    ...
    <section className="relative h-[550px] md:h-[650px] lg:h-[750px] overflow-hidden mx-4 md:mx-8 my-6 rounded-[32px] md:rounded-[40px] shadow-2xl bg-black">
        ...
        >
          ...
          <div className="absolute inset-0">
            <Image
              ...
              fill
              className="object-cover object-right md:object-center brightness-[0.9]"
              priority
              quality={85}
            />
          </div>
          ...
          <div className="container mx-auto px-6 md:px-16 h-full flex items-center relative z-10">
            <div className="max-w-2xl">
              ...
              >
                ...
                <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold text-white heading-font leading-[1.05] tracking-tight max-w-[12ch] md:max-w-none">
      ...
      <div className="absolute bottom-10 right-10 md:bottom-16 md:right-16 flex items-center gap-4 md:gap-8 z-30">
        <div className="hidden md:flex items-center gap-3 text-white font-bold heading-font">
          ...
          <span className="text-white/30 text-sm text-center">0{hero.slides.length}</span>
        </div>
